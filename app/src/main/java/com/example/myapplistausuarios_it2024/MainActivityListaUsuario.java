...
public class MainActivityListaUsuario extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.txtregistro), (v, insets) -> {
    ...
    public void processFinish(String result) throws JSONException {
        TextView txtLista = findViewById(R.id.txtListausuarios);
